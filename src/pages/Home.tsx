...
const Home = () => {
  ...
  return (
    <>
    <h1 className="p-2 m-2 text-center text-3xl mt-3 text-pink-100">Welcome here All of U Guys </h1>
     <div className="max-w-7xl mx-auto p-4 bg-black ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {images.map((img, index) => (
          <div
            key={index}
            className="bg-black text-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition"
          >
            <img
              src={img}
              alt={`card-${index}`}
